...
assert.match(html, /Maquinaria · operación trazable/i);
assert.match(html, /Taller · documentación bloqueante/i);
assert.match(html, /Servicios B2B · presupuestos/i);
assert.match(html, /Partner Coordination · después/i);
assert.match(html, /No presentamos cuatro productos/i);
