...
ok(identity.includes('huella dactilar')&&identity.includes('reconocimiento facial')&&identity.includes('biometría de voz'),'la pantalla de identidad debe conservar las modalidades biométricas simuladas');
