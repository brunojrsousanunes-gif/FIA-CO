...
assert(index.includes('id="servicios"'));
['tx-advanced.html','beta-mobile.html'].forEach(x=>assert(index.includes(x),x));
...
console.log('approved homepage, action index and legal center tests passed');
