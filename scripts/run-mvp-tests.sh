...
node tests/controlled-prepilot.test.mjs
node scripts/run-controlled-prepilot.mjs >/dev/null
...
node tests/counsel-review-scope.test.mjs
...
node tests/hierarchy-scoped-operation-service.test.mjs
