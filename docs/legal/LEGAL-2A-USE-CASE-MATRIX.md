...
| **L2A-7 Identidad/KYC/KYB** | Minimización y proporcionalidad; proveedor desacoplado; separar verificación de identidad de decisión de negocio | Consentimientos/avisos y resultado mínimo necesario; no utilizar biometría y evitar almacenar documentos completos por defecto | Consumir resultado/atributos mínimos; no fingir certificación propia | Orquestación sandbox y flags de revisión | AML/KYC/KYB solo donde sea legalmente exigible/aplicable; identidad no biométrica y transferencias internacionales requieren análisis específico |
...
| Capturar PII real | BLOQUEADO hasta base jurídica, proveedor y controles específicos |
| Capturar o almacenar biometría | EXCLUIDO DEL PRODUCTO; identidad no biométrica |
