...
export function attemptPrepilotBlockerResolution(config={}){
  ...
  return Object.freeze({
    schemaVersion:'prepilot-blocker-resolution-report.v1',
    syntheticOnly:true,
    zeroCost:true,
    ...
    realUserDecision:'NOT_READY_FOR_FOR_REAL_USERS',
    automaticLegalApproval:false,
    automaticDisputeVerdict:false,
